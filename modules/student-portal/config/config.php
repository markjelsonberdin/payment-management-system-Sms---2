...
if (!defined('STUDENT_PORTAL_DB_HOST'))    { define('STUDENT_PORTAL_DB_HOST',    '127.0.0.1;port=3307'); }
if (!defined('STUDENT_PORTAL_DB_NAME'))    { define('STUDENT_PORTAL_DB_NAME',    'sms2_db'); }
